...
const topics = [
  ...
  'mx', 'dns', 'smtp', 'tls', 'spam', 'email-security', 'audit', 'cli',
  'nodejs', 'command-line', 'email-testing', 'dns-records', 'email-marketing',
];
const res = await fetch('https://api.github.com/repos/jtc268/inboxproof-cli', {
  method: 'PUT',
...
if (res.ok) {
  console.log('topics now:', (j.topics || []).join(','));
} else {
